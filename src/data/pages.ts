...
export const guidePages: GuidePage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Analytics and ads", paragraphs: ["If analytics, advertising, or consent tools are enabled, this policy and any required consent controls will be updated before those services are used."] },
    ],
  },
  {
    slug: "terms",
